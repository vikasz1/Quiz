...
public class Quiz3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private Question[] questionBank = new Question[] {
            ...
            new Question(R.string.a3, true),
            new Question(R.string.b3, true),
            new Question(R.string.c3, true),
            new Question(R.string.d3, true),
            new Question(R.string.e3, true),
            new Question(R.string.f3, true),};
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnreset:
                ...
                Intent intent = new Intent(Quiz3.this,MainMenuActivity.class);
